...
# Scenario Wrapper (PowerShell): Office, Corporate laptop, No Corp Proxy, Sequenced

# Defaults
if (-not $PSBoundParameters.ContainsKey('Situation') -or [string]::IsNullOrWhiteSpace($Situation)) { $Situation = "Office_CorporateLaptop_NoCorpProxy_SequencedTest" }
