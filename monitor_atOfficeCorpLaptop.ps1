...
# Scenario Wrapper (PowerShell): Office, Corporate laptop, Corporate Proxy, Sequenced

# Defaults
if (-not $PSBoundParameters.ContainsKey('Situation') -or [string]::IsNullOrWhiteSpace($Situation)) { $Situation = "Office_CorporateLaptop_CorpProxy_SequencedTest" }
