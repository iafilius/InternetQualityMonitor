...
# Scenario Wrapper (PowerShell): Home, Corporate laptop, No Corp Proxy, Sequenced

# Defaults
if (-not $PSBoundParameters.ContainsKey('Situation') -or [string]::IsNullOrWhiteSpace($Situation)) { $Situation = "Home_CorporateLaptop_NoCorpProxy_SequentialTest" }
